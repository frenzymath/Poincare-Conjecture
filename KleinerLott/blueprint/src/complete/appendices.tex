...
\begin{theorem}[maximum principles theorem]
  ...
  \dcref{maximum-principles:theorem-1}
...
\begin{theorem}[estimates for curvature]
  ...
  \dcref{maximum-principles:theorem-2}
  \group{Kleiner--Lott Analytic Appendices}
  \source{kleiner-lott}
...
\begin{theorem}[existence for maximum principles]
  ...
  \dcref{maximum-principles:theorem-3}
  \group{Kleiner--Lott Analytic Appendices}
  \source{kleiner-lott}
...
\cite{Shi2 (1989)}. The extension to $l \: \ge \: 0$ appears in
