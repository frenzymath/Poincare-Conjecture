...
\begin{proposition}[uniqueness for F-entropy]
  ...
  \dcref{invariant-its-applications:proposition-1}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{definition}[lambda invariant]
  ...
  \dcref{invariant-its-applications:definition-2}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{definition}[steady breather definition]
  ...
  \dcref{invariant-its-applications:definition-4}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{definition}[expanding breather definition]
  ...
  \dcref{rescaled-invariant:definition-3}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{proposition}[rigidity of expanding breathers]
  ...
  \dcref{rescaled-invariant:proposition-4}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{proposition}[compactness for Ricci solitons]
  ...
  \dcref{gradient-steady-solitons-compact-manifolds:proposition-1}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{lemma}[gradient-flow formula for the lambda invariant]
  ...
  \dcref{ricci-flow-as-gradient-flow:lemma-1}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
From  \cite[Section 1]{Rothaus (1981)} the infimum is finite and
there is a positive
...
\begin{definition}[locally collapsing definition]
  ...
  \dcref{no-local-collapsing-theorem-i:definition-1}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{remark}[estimates for noncollapsing]
  ...
  \dcref{no-local-collapsing-theorem-i:remark-2}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{remark}[estimates for scalar curvature]
  ...
  \dcref{no-local-collapsing-theorem-i:remark-4}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{remark}[structural remark on noncollapsing]
  ...
  \dcref{no-local-collapsing-theorem-i:remark-6}
  \group{Kleiner--Lott Entropy Functionals}
  \source{kleiner-lott}
...
\begin{definition}[kappa solutions definition]
  ...
  \dcref{no-local-collapsing-propagates-forward-time-larger-scales:definition-1}
  \group{Kleiner--Lott Local Estimates}
  \source{kleiner-lott}
...
\begin{remark}[structural remark on Harnack inequalities]
  ...
  \dcref{perelman-s-differential-harnack-inequality:remark-5}
  \group{Kleiner--Lott Differential Harnack}
  \source{kleiner-lott}
...
\begin{corollary}[existence for kappa solutions]
  ...
  \dcref{noncollapsing-at-future-times:corollary-1}
  \group{Kleiner--Lott Pseudolocality}
  \source{kleiner-lott}
 (cf. Corollary I.10.4)
...
\begin{theorem}[existence for Riemannian metrics]
  ...
  \dcref{diffeomorphism-finiteness:theorem-1}
  \group{Kleiner--Lott Pseudolocality}
  \source{kleiner-lott}
...
\begin{remark}[structural remark on Ricci solitons]
  ...
  \dcref{two-dimensional-solutions:remark-2}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{definition}[asymptotic scalar curvature ratio definition]
  ...
  \dcref{asymptotic-scalar-curvature-asymptotic-volume-ratio:definition-1}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{lemma}[scalar curvature lemma]
  ...
  \dcref{asymptotic-scalar-curvature-asymptotic-volume-ratio:lemma-3}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{definition}[asymptotic volume ratio definition]
  ...
  \dcref{asymptotic-scalar-curvature-asymptotic-volume-ratio:definition-4}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{remark}[structural remark on curvature operators]
  ...
  \dcref{curvature-bounds-ricci-flow-solutions-nonnegative-curvature-operator-ass:remark-2}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\end{remark}
\begin{proof}
  \uses{cor:kl-curvature-bounds-ricci-flow-solutions-nonnegative-curvature-operator-ass-existence-curvature-operators,cor:kl-volume-bound-existence-curvature-operators,lem:kl-getting-parabolic-regions-getting-parabolic-regions-lemma,lem:kl-length-distortion-estimates-distance-distortion-lemma,lem:kl-point-selection-argument-point-selection-argument-lemma,thm:kl-statement-pseudolocality-theorem-pseudolocality-theorem}
...
\begin{remark}[compactness for kappa solutions]
  ...
  \dcref{compactness-space-three-dimensional-solutions:remark-2}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{remark}[compactness for kappa solutions]
  ...
  \dcref{compactness-space-three-dimensional-solutions:remark-3}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
  \uses{cor:kl-two-dimensional-solutions-kappa-solutions-corollary}
...
\begin{corollary}[kappa solutions corollary]
  ...
  \dcref{compactness-space-three-dimensional-solutions:corollary-4}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{definition}[kappa solution definition]
  ...
  \dcref{necklike-behavior-at-infinity-three-dimensional-solution-weak-version:definition-1}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{remark}[existence for Ricci solitons]
  ...
  \dcref{getting-uniform-value:remark-2}
  \group{Kleiner--Lott Kappa Solutions}
  \source{kleiner-lott}
...
\begin{remark}[existence for canonical neighborhoods]
  ...
  \dcref{canonical-neighborhood-theorem:remark-2}
  \group{Kleiner--Lott Canonical Neighborhoods}
  \source{kleiner-lott}
...
\begin{remark}[structural remark on thick--thin geometry]
  ...
  \dcref{later-scalar-curvature-bounds-bigger-balls-from-curvature-volume-bounds:remark-4}
  \group{Kleiner--Lott Canonical Neighborhoods}
  \source{kleiner-lott}
  \uses{thm:kl-canonical-neighborhood-theorem-compactness-canonical-neighborhoods}
...
\begin{remark}[estimates for thick--thin geometry]
  ...
  \dcref{thick-thin-decomposition-nonsingular-flows:remark-2}
  \group{Kleiner--Lott Thick--Thin Decomposition}
  \source{kleiner-lott}
