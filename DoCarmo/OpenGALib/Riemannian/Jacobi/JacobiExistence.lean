...
(`Riemannian.Jacobi.exists_isJacobiFieldOn_Icc_of_curve`), and the chart-change
...
Blueprint: `cor:dc-ch5-2-5` (existence and uniqueness
...
`cor:dc-ch5-2-5`). The geodesic may cross arbitrarily
