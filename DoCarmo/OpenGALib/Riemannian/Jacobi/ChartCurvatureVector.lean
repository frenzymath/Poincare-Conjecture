...
Ported into OpenGALib from the Morgan–Tian / Poincaré Ch.1 development.
This file instantiates the manifold-free curvature-commutation engine of
`OpenGALib.Riemannian.Jacobi.CovariantCurvatureAlong` with the actual Christoffel data of a
...
(`OpenGALib.Riemannian.Geodesic.LinearODE`) and actual
