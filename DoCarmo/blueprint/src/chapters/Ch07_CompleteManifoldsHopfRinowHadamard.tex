...
\begin{definition}[geodesically complete]
  ...
  \lean{Riemannian.Geodesic.IsGeodesicallyComplete}
  \leanok
...
\begin{theorem}[Hopf and Rinow [HR]]
  ...
  \lean{Riemannian.Geodesic.hopfRinow, Riemannian.Geodesic.complete_of_geodesicallyComplete_at, Riemannian.Geodesic.properSpace_of_geodesicallyComplete_at, Riemannian.Geodesic.exists_minimizing_geodesic}
  \leanok
...
\begin{proof}
  \leanok
  \uses{cor:dc-ch3-3-9, thm:dc-ch3-3-7, lem:dc-ch7-2-8-b-to-c, lem:dc-ch7-2-8-a-to-b, lem:dc-ch7-2-8-b-iff-e, lem:dc-ch7-2-8-lipschitz, lem:dc-ch7-2-8-c-to-d}
...
\begin{lemma}[a $\Rightarrow$ b: geodesic completeness at a point makes closed balls compact]
  ...
  \lean{Riemannian.Geodesic.properSpace_of_geodesicallyComplete_at}
  \leanok
...
\begin{lemma}[the global exponential map of a complete manifold]
  ...
  \lean{Riemannian.Geodesic.globalGeodesic, Riemannian.Geodesic.globalGeodesic_eq, Riemannian.Geodesic.globalGeodesic_smul, Riemannian.Exponential.expMapGlobal, Riemannian.Exponential.expMapGlobal_eq_of_isGeodesic, Riemannian.Exponential.expMapGlobal_smul, Riemannian.Exponential.expMapGlobal_surjective}
  \leanok
...
\begin{lemma}[the exponential map of a complete manifold is $C^\infty$]
  ...
  \lean{Riemannian.Exponential.contMDiff_expMapGlobal,
