...
\dcref{ch11:11.1}
\uses{prop:jacobi-field-hessian-equation}
...
\dcref{ch11:11.8}
\uses{prop:hessian-radial-distance-constant-curvature}
\uses{lem:hessian-operator-properties}
...
\dcref{ch11:11.13}
\uses{cor:gradient-radial-distance}
...
\uses{lem:riemannian-volume-laplacian}
\uses{prop:hessian-radial-distance-constant-curvature}
...
\dcref{ch11:11.15}
\uses{thm:laplacian-comparison-1}
\uses{cor:jacobi-field-decomposition}
...
\dcref{ch11:11.16}
\uses{thm:laplacian-comparison-ii}
\uses{lem:riemannian-volume-laplacian}
...
\dcref{ch11:11.19}
\uses{thm:chengs-maximal-diameter}
\uses{thm:gunther-volume-comparison}
\uses{thm:laplacian-comparison-ii}
...
\dcref{ch11:11-1}
\uses{cor:semigeodesic-metric-christoffel}
\uses{ex:polar-normal-coordinates}
...
\uses{thm:jacobi-field-comparison}
\uses{prob:riccati-equation}
\uses{prob:jacobi-field-submanifold}
