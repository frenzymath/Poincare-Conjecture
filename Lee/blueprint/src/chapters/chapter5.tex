...
\dcref{ch5:5.2}
\uses{ex:euclidean-connection}
\uses{prop:tangential-covariant-derivative-projection}
...
\dcref{ch5:5.22}
\uses{prob:local-isometry-determined-point}
...
\uses{prop:exponential-map-properties}
...
\dcref{ch5:5.27}
\uses{cor:geodesic-submanifold-acceleration}
\uses{cor:metric-connection-norm-geodesic}
...
\dcref{ch5:5.13}
\uses{prop:levi-civita-on-euclidean-and-submanifolds}
\uses{cor:geodesic-submanifold-acceleration}
...
\uses{prob:rp-n-frame-homogeneous}
\uses{prob:elliptic-geometry-hilbert}
...
\dcref{ch5:5-5}
\uses{ex:surfaces-of-revolution}
\uses{prob:christoffel-symbols-surface-revolution}
...
\dcref{ch5:5-8}
\uses{prop:bi-invariant-metric-adjoint}
\uses{prop:evaluation-map-lie-algebra-isomorphism}
...
\dcref{ch5:5-16}
\uses{prob:divergence-laplacian-formulas}
...
\dcref{ch5:5-22}
\uses{prop:invariant-tensor-characterization}
\uses{prop:lie-derivative-tensor-product-rule}
