\chapter{Perelman's Differential Harnack Estimate}
\label{ch:chow-ii-perelman-differential-harnack}
\dcref{ch16}
\source{chow-et-al-ricci-flow-part-ii:page-0332}

This chapter develops differential Harnack inequalities for the heat equation
and for the adjoint heat equation coupled to Ricci flow. We use the backward
time variable $\tau$ and write $d\mu$ for the Riemannian measure.
...
\end{theorem}
\begin{proof}
The Bochner formula applied to the equation in
...
\end{corollary}
\begin{proof}
The two preceding results force $\nabla^2f=(2\tau)^{-1}g$ for
...
\end{theorem}
\begin{proof}
The displayed evolution identity follows by differentiating the adjoint heat
...
\end{lemma}
\begin{proof}
The difference of the two kernels is an adjoint supersolution with zero
