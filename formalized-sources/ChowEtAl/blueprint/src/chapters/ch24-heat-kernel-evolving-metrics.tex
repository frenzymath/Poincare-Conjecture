\chapter{Heat Kernel for Evolving Metrics}
...
\end{lemma}
\begin{proof}
Fubini's theorem identifies both bracketings with the integral over
...
\end{lemma}
\begin{proof}
Extend the metric and potential across the double and let \(\widetilde H\) be
...
\end{theorem}
\begin{proof}
For an exhaustion \(\Omega_i\Subset\Omega_{i+1}\), the maximum principle gives
...
\end{lemma}
\begin{proof}
Differentiate the integral, use the heat equation and the nonpositive outward
