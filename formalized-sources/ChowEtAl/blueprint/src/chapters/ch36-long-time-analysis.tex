\chapter{Type II Singularities and Degenerate Neckpinches}
\label{ch:chow-iv-type-ii-degenerate-neckpinches}
\dcref{ch36}
\source{chow-et-al-ricci-flow-part-iv:page-0328}

This chapter surveys numerical and formal matched-asymptotic descriptions of
degenerate neckpinches.  The statements below record the scale conventions,
regional equations, and the topological argument used to obtain solutions
with the predicted asymptotics.
