\chapter{Special Ancient Solutions}
\label{ch:chow-iv-special-ancient-solutions}
\dcref{ch28}
\source{chow-et-al-ricci-flow-part-iv:page-0056}

This chapter studies complete ancient solutions, singularity models, and the
classification of two-dimensional solutions of finite width.  We use
\(\Rm\), \(\Rc\), and \(R\) for the curvature, Ricci, and scalar curvatures.
