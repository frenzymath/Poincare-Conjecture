\chapter{Type I Singularities and Ancient Solutions}
\label{ch:chow-iv-type-i-singularities-ancient-solutions}
\dcref{ch30}
\source{chow-et-al-ricci-flow-part-iv:page-0154}

This chapter develops reduced distance and reduced volume based at a finite
singular time.  These tools produce shrinking soliton models for Type I
singularities and describe asymptotic shrinkers of Type I ancient solutions.
