\chapter{Hyperbolic Geometry and 3-Manifolds}
\label{ch:chow-iv-hyperbolic-geometry-3-manifolds}
\dcref{ch31}
\source{chow-et-al-ricci-flow-part-iv:page-0192}

This chapter records the hyperbolic geometry and 3-manifold topology used in
the analysis of nonsingular three-dimensional Ricci flows.  We write
\(\mathbb H^n\) for hyperbolic space, \(\operatorname{Isom}(\mathbb H^n)\)
for its isometry group, and \(\operatorname{Isom}^+(\mathbb H^n)\) for the
