\chapter{Weak and Strong Maximum Principles on Noncompact Manifolds}
...
\begin{example}[Exercise: an integrable zeroth-order coefficient]
...
Exercise~\ref{ex:wmp-integrable-time-coefficient} applied to the nonnegative
