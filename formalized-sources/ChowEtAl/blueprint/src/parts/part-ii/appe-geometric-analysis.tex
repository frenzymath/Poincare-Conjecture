...
This appendix records the analytic facts used elsewhere in Part II.  The
statements below follow the numbering of the source appendix; proofs are
included only at the level needed to expose the hypotheses and dependencies.
