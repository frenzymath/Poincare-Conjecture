...
\begin{proof}
\source{chow-knopf-ricci-flow:page-0253}
The source states this injectivity-radius estimate as a theorem and indicates that a detailed proof will be given in later work. We record the theorem here as an input to the chapter's dilation arguments.
\end{proof}
...
Let \(K(t)=\sup_{x\in\mathcal M^n}|\Rm(x,t)|^2\). By the curvature evolution inequality from Chapter 7,
\[
...
\begin{proof}
\source{chow-knopf-ricci-flow:page-0261}
The general length variation formula gives
\[
...
\begin{proof}
\source{chow-knopf-ricci-flow:page-0261, chow-knopf-ricci-flow:page-0262}
Assume \(\alpha\) is sufficiently small. Then for large \(t\), the curvature satisfies
\[
