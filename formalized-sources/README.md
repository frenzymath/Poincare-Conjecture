...
These projects follow individual books or articles. They provide detailed,
source-faithful reference developments for the custom proof in the root
`PoincareConjecture/` project.
...
also keeps cross-project Lake paths stable.
