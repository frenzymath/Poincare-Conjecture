...
\begin{lemma}[smooth curves have integrable speed and energy density]
  ...
  \dcref{ch9:2.2}
  \lean{Riemannian.Variation.ContMDiffOn.continuousOn_speedSq_of_isOpen,
    Riemannian.Variation.ContMDiffOn.continuousOn_dcSpeed_of_isOpen,
    Riemannian.Variation.ContMDiffOn.intervalIntegrable_dcSpeed_of_isOpen,
    Riemannian.Variation.ContMDiffOn.intervalIntegrable_dcSpeed_sq_of_isOpen}
  \leanok
...
\begin{lemma}[a smooth fixed-endpoint variation of a minimizer minimizes energy]
  ...
  \leanok
  \uses{lem:dc-ch9-2-2-smooth-speed-integrable,
    lem:dc-ch9-2-3-arclength-bridge,lem:dc-ch9-2-3-inequality}
...
\begin{lemma}[the proper sine exponential variation]
  ...
  \dcref{ch9:3.1}
  \lean{Riemannian.Variation.bonnetMyersSineVariation,
    Riemannian.Variation.bonnetMyersSineVariation_zero,
    Riemannian.Variation.bonnetMyersSineVariation_left,
    Riemannian.Variation.bonnetMyersSineVariation_right,
    Riemannian.Variation.hasDerivAt_bonnetMyersSineVariation_zero,
    Riemannian.Variation.exists_contMDiffOn_infty_bonnetMyersSineVariation_strip}
  \leanok
...
\begin{lemma}[energy minimality of the sine variation]
  ...
  \leanok
  \uses{lem:dc-ch9-2-3-smooth-variation-energy-min,
    lem:dc-ch9-3-1-sine-variation}
...
the \emph{index form} $I_a$ rather than $E_j''(0)$. The concrete sine variation and its
energy minimality are \cref{lem:dc-ch9-3-1-sine-variation,lem:dc-ch9-3-1-sine-energy-min};
passing from its second energy derivative to the index form still requires the specialization
of formula (6), \cref{lem:dc-ch9-2-10-formula6}, to that surface and its covariant derivative
fields. The node below therefore records the summed negativity, the frame, and the Ricci sum.
...
\begin{theorem}[Bonnet–Myers]
  ...
  \uses{lem:dc-ch9-2-3, prop:dc-ch9-2-8, lem:dc-ch9-3-1-velocity-frame,
    ...
    lem:dc-ch9-3-1-sine-variation,lem:dc-ch9-3-1-sine-energy-min,
