...
Let $p\in M$, let $v\in T_pM$ lie in the domain of $\exp_p$, and identify
$T_v(T_pM)$ with $T_pM$. If $v(s)$ is a curve with $v(0)=v$ and $v'(0)=w$, set
$f(t,s)=\exp_p(tv(s))$. Then
...
Thus $J(t)=\frac{\partial f}{\partial s}(t,0)$ along
$\gamma(t)=\exp_p(tv)$ satisfies
...
\begin{definition}[Jacobi field]
  ...
  a \emph{Jacobi field} if it satisfies (1) on $[0,a]$.
