% Source: Lee, "Introduction to Riemannian Manifolds" (2nd ed.), Chapter 8 "Riemannian Submanifolds", PDF pages 236-273 of the cited source.
...
\dcref{ch8:8.18}
\uses{thm:minimizing-geodesic-unit-speed,ex:fermi-coordinates-hypersurface}
