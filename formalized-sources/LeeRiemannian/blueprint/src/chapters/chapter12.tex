% Source: Lee, "Introduction to Riemannian Manifolds" (2nd ed.), Chapter 12 "Curvature and Topology", PDF pages 355-380 of the cited source.
...
\dcref{ch12:12.24}
\notready
\uses{cor:diameter-ricci-bounded,cor:complete-iff-covering-complete,prop:fiber-cardinality-fundamental-group}
