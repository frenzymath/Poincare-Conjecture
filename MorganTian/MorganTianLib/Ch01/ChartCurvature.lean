...
`MorganTianLib.Ch01.CurvatureCommutation` with the actual Christoffel data of a
...
(`MorganTianLib.Ch01.JacobiODE`, `lem:second-order-linear-ode`) and actual
...
the curvature-commutation engine (`MorganTianLib.covDerivAlong`,
