...
\lean{PoincareLib.RiemannianMetric}
\leanok
...
\lean{PoincareLib.existsUnique_leviCivita}
\leanok
...
\lean{PoincareLib.hessian,PoincareLib.hessian_symm,PoincareLib.hessian_smul,PoincareLib.hessianAt_symm,PoincareLib.hessian_eq_metricInner_cov_gradientField,PoincareLib.hessianAt_chartBasisVecFiber}
\leanok
...
\uses{thm:levi-civita-connection}
\lean{PoincareLib.riemannCurvature,PoincareLib.curvatureForm}
\leanok
...
\lean{PoincareLib.curvatureForm_symmetries,PoincareLib.curvatureForm_secondBianchi}
\leanok
...
\uses{def:riemann-curvature-tensor}
\lean{PoincareLib.sectionalCurvatureAt}
\leanok
...
\lean{PoincareLib.hasConstantSectionalCurvature_iff_curvatureFormAt_eq}
\leanok
...
\lean{PoincareLib.curvatureOperator,PoincareLib.curvatureOperator_ιMulti,PoincareLib.curvatureOperator_symm,PoincareLib.sectionalCurvature_eq_curvatureOperator,PoincareLib.HasPositiveCurvatureOperator,PoincareLib.HasNonnegativeCurvatureOperator,PoincareLib.sectionalCurvature_nonneg_of_hasNonnegativeCurvatureOperator}
\leanok
...
\lean{PoincareLib.wedgeInner,PoincareLib.HasCurvatureOperatorNormLe,PoincareLib.abs_curvatureForm_le_of_hasCurvatureOperatorNormLe,PoincareLib.exists_orthonormal_changeBasis,PoincareLib.abs_sectionalCurvature_le_of_hasCurvatureOperatorNormLe}
\leanok
...
\uses{def:riemann-curvature-tensor}
\lean{PoincareLib.ricciAt,PoincareLib.scalarCurvatureAt}
\leanok
...
\lean{PoincareLib.metricInner_riemannCurvature_eq_curvatureFormAt,PoincareLib.sum_metricInner_riemannCurvature_self_eq_ricciAt}
\leanok
...
\lean{PoincareLib.dir_scalarCurvature_eq_two_divRicci,PoincareLib.divRicciAt,PoincareLib.covRicciAt,PoincareLib.divRicciAt_eq_sum_orthonormalBasis,PoincareLib.covRicci_eq_frame_sum,PoincareLib.dir_scalarCurvatureAt_eq_two_frame_covRicci,PoincareLib.covRicci_congr_apply}
\leanok
...
\lean{PoincareLib.secondCov_add_left,PoincareLib.secondCov_smul_left,PoincareLib.secondCov_add_middle,PoincareLib.secondCov_smul_middle,PoincareLib.secondCov_congr_left}
\leanok
...
\lean{PoincareLib.secondCov_sub_swap}
\leanok
...
\lean{PoincareLib.oneFormLaplacianAt,PoincareLib.oneFormLaplacianAt_eq_sum_frame,PoincareLib.metricInner_secondCov_gradientField_symm,PoincareLib.sum_metricInner_secondCov_along_frame_eq_dir_laplacianAt,PoincareLib.sum_metricInner_riemannCurvature_frame_eq_ricciAt,PoincareLib.oneFormLaplacianAt_gradientField_eq_dirTangent_laplacianAt_add_ricciAt,PoincareLib.oneFormLaplacianAt_gradientField_eq_metricInner_gradientAt_add_ricciAt}
\leanok
...
\lean{PoincareLib.IsEinstein.sectionalCurvature_const}
\leanok
...
\label{def:geodesic}
\uses{thm:levi-civita-connection}
\lean{PoincareLib.IsGeodesic,PoincareLib.IsGeodesicOn}
\leanok
...
\lean{PoincareLib.covDerivAlong,PoincareLib.christoffelCurvature,PoincareLib.covDerivAlong_comm,PoincareLib.covDerivAlong_fderiv_symm,PoincareLib.covDerivAlong_geodesic_family_jacobi,PoincareLib.chartChristoffelBilin,PoincareLib.chartCurvature,PoincareLib.chart_geodesic_family_jacobi}
\leanok
...
\lean{PoincareLib.chartCurvatureEndo,PoincareLib.IsJacobiFieldOn,PoincareLib.jacobiPairCoeffCoord,PoincareLib.exists_isJacobiFieldOn_Icc,PoincareLib.exists_isJacobiFieldOn_Icc_of_curve,PoincareLib.continuousOn_jacobiPairCoeffCoord,PoincareLib.IsJacobiFieldOn.eqOn_of_left,PoincareLib.IsJacobiFieldOn.eqOn_of_right,PoincareLib.IsJacobiFieldOn.add,PoincareLib.IsJacobiFieldOn.const_smul,PoincareLib.IsJacobiFieldOn.eqOn_zero}
\leanok
...
\lean{PoincareLib.curvatureFormAt_chartFrame,PoincareLib.chartCurvature_basis,PoincareLib.exists_chartFrame_leviCivita_christoffel_nhds,PoincareLib.exists_contMDiff_eventuallyEq,PoincareLib.cov_congr_apply_right,PoincareLib.alg_curvature_le_of_sectionalCurvature_le,PoincareLib.chartCurvature_pairing_le_of_sectionalCurvatureAt_le,PoincareLib.chartCurvature_pairing_le_of_sectionalCurvatureAt_le'}
\leanok
...
\lean{PoincareLib.IsParallelSolOn,PoincareLib.exists_parallelFrame_Icc,PoincareLib.IsParallelSolOn.eqOn_of_left,PoincareLib.IsParallelSolOn.chartMetricInner_eq,PoincareLib.chartMetricInner_parallelFrame_eq}
\leanok
Let $(M,g)$ be a Riemannian manifold with Levi-Civita connection
...
\lean{PoincareLib.IsJacobiSolOn,PoincareLib.exists_isJacobiSolOn_Icc,PoincareLib.IsJacobiSolOn.eqOn_of_left,PoincareLib.IsJacobiSolOn.eqOn_of_right,PoincareLib.IsJacobiSolOn.add,PoincareLib.IsJacobiSolOn.const_smul,PoincareLib.IsJacobiSolOn.sub,PoincareLib.IsJacobiSolOn.eqOn_zero}
\leanok
...
\lean{PoincareLib.chartVectorRep,PoincareLib.IsJacobiFieldAlongOn,PoincareLib.IsConjugatePointAt}
\leanok
...
\lean{PoincareLib.not_isConjugatePointAt_of_minimizing,
  PoincareLib.indexForm_nonneg_of_minimizing,
  PoincareLib.dist_eq_speed_mul_of_minimizing,
  PoincareLib.minimalGeodesic_restrict_unique,
  PoincareLib.eqOn_of_minimizing_geodesic_of_minimizing_geodesic,
  PoincareLib.globalGeodesic_eqOn_of_minimizing}
\leanok
% BOTH assertions are now formalized and kernel-checked (run 0119):
%   Part 1 (uniqueness)      PoincareLib.minimalGeodesic_restrict_unique
%   Part 2 (no conjugate pt) PoincareLib.not_isConjugatePointAt_of_minimizing
...
(\texttt{PoincareLib.minimalGeodesic\_restrict\_unique}), for a structural reason: the
...
\uses{thm:levi-civita-connection}
\lean{PoincareLib.isMetricCompatibleAt_chartMetricBilin}
\leanok
...
\lean{PoincareLib.secondVariation_energyDensity}
\leanok
...
\lean{PoincareLib.exists_indexForm_neg_of_isConjugatePointAt}
\leanok
...
%   PoincareLib.not_isConjugatePointAt_of_minimizing  (Ch01/MinimalGeodesicNoConjugate.lean)
...
% PoincareLib.not_isConjugatePointAt_of_minimizing_radial_Ioo (Ch01/NoConjugateOfMinimizing.lean):
...
%              "is MINIMAL"  PoincareLib.dist_eq_speed_mul_of_minimizing
...
%              "is UNIQUE"   PoincareLib.minimalGeodesic_restrict_unique
%                            PoincareLib.eqOn_of_minimizing_geodesic_of_minimizing_geodesic
%                            PoincareLib.globalGeodesic_eqOn_of_minimizing   (the radial form)
...
% corner" -- which OpenGALib ALREADY HAD, kernel-checked:
%     Riemannian.Exponential.isGeodesicOn_piecewise_of_arclength_edist
%       (DoCarmo/OpenGALib/Riemannian/Exponential/MinimizingGeodesic.lean)
...
% minimality statement, grep OpenGALib for the do Carmo corollary that already says it.  The
...
%   Cure: `open scoped Bundle`.  Every OpenGALib file that states a pathELength lemma has it.
...
%     PoincareLib.globalGeodesic_eqOn_of_minimizing   (Ch01/MinimalGeodesicUnique.lean, axiom-clean)
...
%        PoincareLib.exists_indexForm_neg_of_isConjugatePointAt, Ch01/IndexFormConjugate.lean).
...
%          PoincareLib.exists_indexForm_neg_smooth_of_isConjugatePointAt
...
%        PoincareLib.indexForm_nonneg_of_minimizing (Ch01/MinimalGeodesicNoConjugate.lean).
%        The variation is BROKEN -- one chart per piece, because gamma leaves every chart -- and
%        it is CONSTRUCTED, not assumed:
%          - PoincareLib.exists_brokenVariationData (Ch01/BrokenVariationData.lean) builds the
...
\uses{def:geodesic}
\lean{PoincareLib.expMap,PoincareLib.expDomain}
\leanok
...
%   PoincareLib.sprayFlow_eq_chartState — the semantic core: a spray flow state IS
...
%   PoincareLib.hasStrictFDerivAt_comp_chain_nbhd — the composition engine now
...
% PoincareLib/Ch01/GeodesicOfState.lean (assumes M complete, as Morgan-Tian do
% throughout -- a documented strengthening of the ambient hypotheses of this lemma):
%   PoincareLib.exists_geodesic_chartState — on a complete manifold, every chart-beta
...
%   PoincareLib.eq_of_chartState_eq — two global geodesics sharing ONE chart-beta
...
%   (i) exists_geodesic_jacobiTransport_chain_nbhd (PoincareLib/Ch01/FlowChainNbhd.lean)
...
%   (ii)-(iv) PoincareLib/Ch01/ExpDifferential.lean.  Compose F_0 with the initial-state
...
%   (b) The Lean uses PoincareLib.expMapGlobal (PoincareLib/Ch01/GlobalExp.lean), NOT
...
\lean{PoincareLib.IsJacobiFieldOn.transfer,PoincareLib.chartCurvature_coordChange,PoincareLib.exists_isJacobiFieldAlongOn,PoincareLib.IsJacobiFieldAlongOn.eqOn_of_initial,PoincareLib.IsJacobiFieldAlongOn.isJacobiFieldOn_of_mem_source,PoincareLib.exists_geodesic_chart_partition,PoincareLib.hasStrictFDerivAt_comp_chain,PoincareLib.hasStrictFDerivAt_comp_chain',PoincareLib.jacobiVarPair_of_left_eq_zero,PoincareLib.exists_geodesic_flow_step_jacobiTransport,PoincareLib.exists_geodesic_flow_step_jacobiTransport_manifold,PoincareLib.IsGeodesicOn.comp_const_add,PoincareLib.exists_geodesic_flow_step_jacobiTransport_manifold_at,PoincareLib.exists_geodesic_flow_step_jacobiTransport_manifold_ball,PoincareLib.exists_geodesic_flowstep_partition,PoincareLib.exists_geodesic_junction_step,PoincareLib.IsJacobiFieldAlongOn.mono,PoincareLib.exists_geodesic_jacobiTransport_chain,PoincareLib.sprayFlow_eq_chartState,PoincareLib.hasStrictFDerivAt_comp_chain_nbhd,PoincareLib.exists_geodesic_chartState,PoincareLib.eq_of_chartState_eq,PoincareLib.stateTransition_chartState,PoincareLib.exists_geodesic_jacobiTransport_chain_nbhd,PoincareLib.globalGeodesic,PoincareLib.globalGeodesic_eq,PoincareLib.expMapGlobal,PoincareLib.expMapGlobal_eq_of_isGeodesic,PoincareLib.hasFDerivAt_chartReading_expMapGlobal,PoincareLib.expDifferential_eq_jacobiField}
\leanok
...
\lean{PoincareLib.expMapGlobal_localDiffeo_of_minimizing}
\leanok
...
\label{def:cut-time}
\uses{def:exponential-map,def:geodesic}
\lean{PoincareLib.IsMinimizingUpTo,PoincareLib.minimizingTimes,PoincareLib.cutTime}
\leanok
...
\uses{def:cut-time}
\lean{PoincareLib.IsMinimizingUpTo.mono,PoincareLib.minimizingTimes_ordConnected}
\leanok
...
\lean{PoincareLib.segmentDomain,PoincareLib.cutLocus,PoincareLib.injectivityRadius}
\leanok
...
\lean{PoincareLib.isMinimizingUpTo_smul,PoincareLib.segmentDomain_smul_mem}
\leanok
...
\lean{PoincareLib.le_cutTime_iff,PoincareLib.measurable_cutTime}
\leanok
...
\lean{PoincareLib.IsRadialGraph,PoincareLib.addHaar_eq_zero_of_isRadialGraph}
\leanok
...
\lean{PoincareLib.riemannianMeasure_eq_zero_of_chartImage_null,
  PoincareLib.riemannianMeasure_image_eq_zero_of_null,
  PoincareLib.riemannianMeasure_expMapGlobal_image_eq_zero}
\leanok
...
\lean{PoincareLib.cutLocus_subset_image_cutVectors,
  PoincareLib.isRadialGraph_cutVectors,
  PoincareLib.measurableSet_cutVectors,
  PoincareLib.riemannianMeasure_cutLocus_eq_zero}
\leanok
...
\uses{def:cut-locus}
\lean{PoincareLib.expDifferential_isEquiv_of_minimizing_radial,
  PoincareLib.expMapGlobal_locallyInjective_of_minimizing_radial,
  PoincareLib.injOn_expMapGlobal_segmentDomain,
  PoincareLib.exists_mem_segmentDomain_expMapGlobal_eq}
...
%     PoincareLib.minimalGeodesic_restrict_unique   (Ch01/MinimalGeodesicUnique.lean)
...
%     PoincareLib.injOn_expMapGlobal_segmentDomain   (Ch01/SegmentInjective.lean, axiom-clean:
...
%     PoincareLib.exists_mem_segmentDomain_expMapGlobal_eq   (Ch01/SegmentSurjective.lean,
...
\lean{PoincareLib.laplacianAt_eq_chart_formula,PoincareLib.laplacianAt_eq_invGram_sum}
\leanok
...
\lean{PoincareLib.laplacianAt_eq_chart_divergence}
\leanok
...
\lean{PoincareLib.chartCurvature_inner_velocity_eq_zero,PoincareLib.innerVelocity,PoincareLib.innerVelocity_eq_chartMetricInner_of_geodesicAt,PoincareLib.IsJacobiFieldOn.hasDerivAt_chartInner_fst_velocity,PoincareLib.IsJacobiFieldOn.hasDerivAt_chartInner_snd_velocity,PoincareLib.IsJacobiFieldAlongOn.innerVelocity_snd_eq,PoincareLib.IsJacobiFieldAlongOn.innerVelocity_fst_eq,PoincareLib.IsJacobiFieldAlongOn.innerVelocity_fst_eq_zero,PoincareLib.IsJacobiFieldAlongOn.innerVelocity_snd_eq_zero}
\leanok
...
\lean{PoincareLib.curvatureFormAt_jacobi_symm,PoincareLib.chartCurvature_inner_symm,PoincareLib.chartCurvatureEndo_inner_symm}
\leanok
...
% charts, in PoincareLib/Ch01/FrameJacobiSystem.lean:
%   PoincareLib.exists_orthonormalParallelFrameAlong  — a parallel g-orthonormal
...
%   PoincareLib.IsJacobiFieldAlongOn.exists_frameJacobiSystem — in that frame the
...
%   PoincareLib.curvatureFormAt_jacobi_symm      (self-adjointness of R_u on T_pM)
%   PoincareLib.metricInner_orthonormal_expansion (v = sum_i <v,e_i> e_i on T_qM)
%
...
%   PoincareLib.continuousOn_frameCurv (PoincareLib/Ch01/FrameCurvContinuity.lean)
...
%   PoincareLib.exists_isRadialJacobi (PoincareLib/Ch01/RadialJacobiExists.lean)
...
%   PoincareLib.exists_isRadialJacobi_of_geodesic (Ch01/FrameRadialBridge.lean)
...
%       PoincareLib.expDifferential_metricInner_le_of_not_conjugate, Ch01/PolarMetricComparison.lean)
%           |d(exp_p)_{ru}(Z)|_g^2 <= (sn_k(r)/r)^2 |Z|_g^2;
%   part (4) -- lem:exp-pullback-volume-comparison (\leanok,
%       PoincareLib.expDifferential_det_le_of_not_conjugate, Ch01/PolarVolumeComparison.lean)
...
\lean{PoincareLib.IsJacobiSolOn.max_norm_le,PoincareLib.IsJacobiSolOn.norm_snd_le,PoincareLib.IsJacobiSolOn.norm_fst_le,PoincareLib.IsJacobiSolOn.norm_snd_sub_le,PoincareLib.IsJacobiSolOn.norm_fst_sub_le}
\leanok
...
\lean{PoincareLib.IsJacobiSolOn.norm_one_sub_inv_smul_fst_le,PoincareLib.IsJacobiSolOn.isUnit_fst,PoincareLib.IsJacobiSolOn.norm_snd_mul_inverse_fst_sub_le}
\leanok
...
\lean{PoincareLib.isUnit_of_not_isConjugatePointAt,PoincareLib.exists_isJacobiFieldAlongOn_mem,PoincareLib.IsJacobiFieldAlongOn.eqOn_zero_of_mem,PoincareLib.frameVec_frameLift}
\leanok
...
\lean{PoincareLib.IsRadialJacobi,PoincareLib.jacobiOpCoeff,PoincareLib.shapeOp,PoincareLib.wronskian_eq,PoincareLib.shapeOp_symm,PoincareLib.hasDerivAt_shapeOp,PoincareLib.tendsto_shapeOp_sub_inv_smul_id,PoincareLib.IsRadialJacobi.isUnit_fst}
\leanok
...
\lean{PoincareLib.shapeOp_inner_le,PoincareLib.norm_jacobi_sq_le,PoincareLib.trace_shapeOp_le,PoincareLib.tendsto_snK_div_self,PoincareLib.tendsto_norm_jacobi_div_self}
\leanok
...
\lean{PoincareLib.volumeElement,PoincareLib.hasDerivAt_volumeElement}
\leanok
...
\lean{PoincareLib.scalar_riccati_comparison,PoincareLib.scalar_riccati_comparison_Ioi}
\leanok
...
\lean{PoincareLib.antitoneOn_div_sq_of_deriv_le,PoincareLib.monotoneOn_div_sq_of_le_deriv}
\leanok
...
\lean{PoincareLib.scalar_sturm_comparison,PoincareLib.scalar_sturm_pos}
\leanok
...
\lean{PoincareLib.vector_sturm_comparison,PoincareLib.vector_sturm_ne_zero,PoincareLib.tendsto_norm_div_self_of_hasDerivWithinAt}
\leanok
...
\lean{PoincareLib.jacobi_frame_sturm_comparison,PoincareLib.jacobi_ne_zero_of_curvature_le,PoincareLib.chartMetricInner_parseval,PoincareLib.exists_chartMetricInner_orthonormal,PoincareLib.chartMetricInner_pos}
\leanok
...
\lean{PoincareLib.not_isConjugatePointAt_of_sectionalCurvatureAt_le,PoincareLib.IsJacobiFieldAlongOn.sqrt_metricInner_comparison,PoincareLib.IsJacobiFieldAlongOn.ne_zero_of_sectionalCurvatureAt_le,PoincareLib.IsJacobiFieldAlongOn.eqOn_zero,PoincareLib.scalar_sturm_comparison_extend,PoincareLib.scalar_sturm_comparison_of_start}
\leanok
...
\lean{PoincareLib.operator_riccati_nonneg,PoincareLib.minRayleigh,PoincareLib.le_of_left_slope_eventually_lt,PoincareLib.apply_eq_minRayleigh_smul}
\leanok
...
\lean{PoincareLib.operator_riccati_le}
\leanok
...
\lean{PoincareLib.exists_isRadialJacobi,
PoincareLib.IsJacobiSolOn.apply,
PoincareLib.continuousOn_frameCurv,
PoincareLib.frameCurvOp_symm,
PoincareLib.isJacobiSolOn_frameVec,
PoincareLib.exists_isRadialJacobi_of_geodesic,
PoincareLib.curvatureFormAt_jacobi_le_of_sectionalCurvatureAt_ge,
PoincareLib.metricInner_jacobi_le_snK,
PoincareLib.metricInner_jacobi_le_snK_of_sectionalCurvature}
\leanok
...
\lean{PoincareLib.sectional_curvature_comparison}
\leanok
...
\lean{PoincareLib.expDifferential_metricInner_le_of_not_conjugate,PoincareLib.expDifferential_metricInner_le_of_sectionalCurvature}
\leanok
...
\lean{PoincareLib.expDifferential_det_le_of_not_conjugate,PoincareLib.expDifferential_det_le_of_sectionalCurvature}
\leanok
...
% below, and is the node that carries the \leanok (PoincareLib.sectional_curvature_comparison,
...
\lean{PoincareLib.expDifferential_metricInner_le_of_minimizing,
  PoincareLib.sectional_curvature_comparison_radial_of_minimizing}
\leanok
...
% PoincareLib.sectional_curvature_comparison, Ch01/SectionalComparison.lean, axiom-clean).
...
% PoincareLib.sectional_curvature_comparison_of_not_conjugate (Ch01/ComparisonGeometric.lean,
...
% (PoincareLib.ricci_curvature_comparison_of_not_conjugate).
...
%     PoincareLib.expDifferential_metricInner_le_of_minimizing         (metric half)
%     PoincareLib.sectional_curvature_comparison_radial_of_minimizing  (BOTH halves, incl. the
...
% for the comparison chain by PoincareLib.not_isConjugatePointAt_of_minimizing_radial_Ioo
...
\lean{PoincareLib.curvatureTangentBall,
PoincareLib.curvatureBall,
PoincareLib.HasCurvatureOperatorNormLeOn,
PoincareLib.hasStrictFDerivAt_chartReading_expMapGlobal,
PoincareLib.speedSq_globalGeodesic,
PoincareLib.globalGeodesic_smul,
PoincareLib.not_isConjugatePointAt_one_of_sectionalCurvatureAt_le,
PoincareLib.not_isConjugatePointAt_one_zero_vec,
PoincareLib.not_isConjugatePointAt_one_of_hasCurvatureOperatorNormLeOn,
PoincareLib.expDifferential_isEquiv_of_not_conjugate,
PoincareLib.expMapGlobal_locallyInjective_of_not_conjugate,
PoincareLib.expMapGlobal_map_nhds_of_not_conjugate,
PoincareLib.expMapGlobal_isLocalHomeomorphAt_of_not_conjugate,
PoincareLib.continuousAt_expMapGlobal,
PoincareLib.continuous_expMapGlobal,
PoincareLib.dist_expMapGlobal_le,
PoincareLib.expMapGlobal_mapsTo_curvatureBall,
PoincareLib.expMapGlobal_isLocalDiffeo_curvatureBall}
\leanok
Fix $K\ge 0$, with the convention $\pi/\sqrt K=+\infty$ for $K=0$.
...
\uses{def:sinh-comparison-function}
\lean{PoincareLib.trace_riccati_comparison,PoincareLib.sq_trace_le_finrank_mul_trace_comp_self}
\leanok
...
%     (gap (i) of the previous status note)  -- PoincareLib.volumeElement_pos,
%     PoincareLib.tendsto_volumeElement_div_pow (Ch01/VolumeAsymptotics.lean);
%   * the monotonicity engine for the power n-1 -- PoincareLib.antitoneOn_div_pow_of_deriv_le
...
%   PoincareLib.sq_trace_sub_le (Ch01/SharpTrace.lean) -- the sharp trace
...
%       first vector is u;
%   PoincareLib.trace_riccati_comparison_perp, PoincareLib.trace_shapeOp_le_perp --
...
%   PoincareLib.trace_frameCurvOp_eq_ricciAt, PoincareLib.frameCurvOp_radial_eq_zero
...
%   PoincareLib.exists_isRadialJacobi_of_geodesic_velocity (Ch01/RadialJacobiVelocity.lean)
...
% (PoincareLib.polarDensity); identifying it with sqrt(det g(r,theta)/det ghat(theta))
...
\lean{PoincareLib.sq_trace_sub_le,PoincareLib.trace_riccati_comparison_perp,PoincareLib.IsRadialJacobi.apply_radial,PoincareLib.shapeOp_apply_radial,PoincareLib.trace_shapeOp_le_perp,PoincareLib.antitoneOn_div_pow_of_deriv_le,PoincareLib.tendsto_volumeElement_div_pow,PoincareLib.volumeElement_pos,PoincareLib.polarDensity,PoincareLib.hasDerivAt_polarDensity,PoincareLib.antitoneOn_polarDensity_div_snK_pow,PoincareLib.tendsto_polarDensity_div_snK_pow,PoincareLib.polarDensity_le_snK_pow,PoincareLib.trace_frameCurvOp_eq_ricciAt,PoincareLib.frameCurvOp_radial_eq_zero,PoincareLib.exists_isRadialJacobi_of_geodesic_velocity,PoincareLib.ricci_curvature_comparison}
\leanok
...
% PoincareLib.ricci_curvature_comparison (Ch01/RicciComparison.lean) proves BOTH
...
%       quantities Tr A(r) - 1/r and det J(r)/r (PoincareLib.polarDensity), which are
...
% PoincareLib.ricci_curvature_comparison_of_not_conjugate (Ch01/ComparisonGeometric.lean,
...
% PoincareLib.ricci_curvature_comparison was also strengthened to expose the g-orthonormality
...
%     PoincareLib.expDifferential_det_le_of_minimizing        volume element:
%                                                             0 < det d(exp_p)_{ru} <= (sn_k/r)^{n-1}
%     PoincareLib.ricci_curvature_comparison_radial_of_minimizing
...
% (PoincareLib.not_isConjugatePointAt_of_minimizing_radial_Ioo).
...
\lean{PoincareLib.ricci_curvature_comparison,
  PoincareLib.expDifferential_det_le_of_minimizing,
  PoincareLib.ricci_curvature_comparison_radial_of_minimizing}
\leanok
...
\lean{PoincareLib.antitoneOn_integral_ratio}
\leanok
...
\lean{PoincareLib.tendsto_integral_ratio}
\leanok
Let $R>0$ and let $f,g\colon(0,R)\to\mathbb R$ be integrable on $(0,r)$ for
...
\lean{PoincareLib.bishop_gromov_radial,PoincareLib.tendsto_bishop_gromov_radial}
\leanok
...
\uses{def:riemannian-metric}
\lean{PoincareLib.chartVolumeDensity}
\leanok
...
\lean{PoincareLib.chartGramMatrix_det_change,PoincareLib.sqrt_chartGramMatrix_det_change}
\leanok
...
\lean{PoincareLib.chartMeasure_apply_eq}
\leanok
...
\lean{PoincareLib.riemannianMeasure,PoincareLib.riemannianMeasure_apply_chart}
\leanok
...
\lean{PoincareLib.riemannianMeasure_eq_lintegral_jacobian}
\leanok
...
\uses{def:chart-volume-density}
\lean{PoincareLib.HasRiemannianJacobianOn}
\leanok
...
\lean{PoincareLib.riemannianMeasure_image_eq_lintegral_jacobian}
\leanok
...
\lean{PoincareLib.expRiemannianJacobian,PoincareLib.hasRiemannianJacobianOn_expMapGlobal,
  PoincareLib.riemannianMeasure_image_segmentDomain_eq_lintegral}
\leanok
...
\lean{PoincareLib.lintegral_eq_polar,PoincareLib.setLIntegral_ball_eq_polar}
\leanok
...
\lean{PoincareLib.modelBallVolume_eq}
\leanok
...
\lean{PoincareLib.bishop_gromov_ball,PoincareLib.bishop_gromov_ball_ratio}
\leanok
...
% PoincareLib.bishop_gromov_radial, Ch01/BishopGromov.lean, axiom-clean) is the
...
%   PoincareLib.expRiemannianJacobian_smul_eq_of_frameRead -- given the frame reading Phi of
...
%   PoincareLib.expRiemannianJacobian_smul_factor_of_not_conjugate -- from the comparison hypotheses
