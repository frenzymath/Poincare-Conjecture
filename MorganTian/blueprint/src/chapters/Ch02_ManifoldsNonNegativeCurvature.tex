...
\lean{PoincareLib.IsGeodesicRay}
\leanok
\uses{def:geodesic}
\source{morgan-tian}
...
\lean{PoincareLib.IsMinGeodesicOn}
\leanok
...
\lean{PoincareLib.HasMinSegments}
\leanok
...
\lean{PoincareLib.exists_isMinGeodesicOn_hyperfilter_limit}
\leanok
\uses{def:minimizing-geodesic-window}
\source{morgan-tian}
...
\lean{PoincareLib.exists_isMinGeodesicOn_tendstoLocallyUniformlyOn}
\leanok
\uses{def:minimizing-geodesic-window}
\source{morgan-tian}
...
\lean{PoincareLib.exists_isGeodesicRay_of_noncompact}
\leanok
...
\lean{PoincareLib.SpaceOfEnds.exists_apply_ne}
\leanok
...
\lean{PoincareLib.SpaceOfEnds.exists_mem_connectedComponentIn_forall_le_dist}
\leanok
...
\lean{PoincareLib.exists_isMinGeodesicOn_univ_of_ends_ne}
\leanok
...
\lean{PoincareLib.exists_globalGeodesic_initial,
  PoincareLib.eqOn_of_initial_data,
  PoincareLib.convAt_of_convAt_zero,
  PoincareLib.tendsto_apply_of_convAt_zero,
  PoincareLib.tendstoUniformlyOn_of_convAt_zero}
\leanok
...
% `PoincareLib/Ch02/GeodesicContinuousDependence.lean`.  Part (1): existence is
...
% `PoincareLib.convStepProperty` of `lem:ends-exist` (its clopen propagation is
...
\lean{PoincareLib.exists_isMinGeodesicOn_convAt_of_tendsto}
\leanok
\uses{def:geodesic}
\source{morgan-tian}
...
% `PoincareLib.exists_isMinGeodesicOn_convAt_of_tendsto` in
% `PoincareLib/Ch02/LimitMinimizingGeodesics.lean`.  The Lean statement uses the
...
\lean{PoincareLib.hasMinSegments_of_complete}
\leanok
\uses{def:geodesic}
...
% `PoincareLib.hasMinSegments_of_complete` proves the metric-space predicate
...
\label{ends}
\lean{PoincareLib.exists_isGeodesicRay_of_complete_noncompact', PoincareLib.exists_isMinGeodesicOn_univ_of_complete_ends_ne', PoincareLib.properSpace_of_complete', PoincareLib.geodesicEndpointContinuity, PoincareLib.convStepProperty}
\leanok
...
% produced by the unconditional `PoincareLib.exists_isGeodesicRay_of_complete_noncompact'`
...
% `PoincareLib.geodesicEndpointContinuity`: the reduction
...
% flow-box step `PoincareLib.convStepProperty` (the universally quantified form of
...
\lean{PoincareLib.lipschitzWith_busemannAux}
\leanok
...
\lean{PoincareLib.busemannAux_antitoneOn}
\leanok
\uses{def:busemann-approx}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.neg_dist_le_busemannAux}
\leanok
\uses{def:busemann-approx}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.tendsto_busemannAux_atTop}
\leanok
...
\lean{PoincareLib.busemann_le_busemannAux}
\leanok
\uses{def:busemann-function}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.lipschitzWith_busemann}
\leanok
\uses{def:busemann-function}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.neg_dist_le_busemann}
\leanok
\uses{def:busemann-function}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.busemann_apply_ray}
\leanok
\uses{def:busemann-function}
Let $\lambda\colon [0,\infty)\to M$ be a minimizing geodesic ray.
...
\lean{PoincareLib.IsAsymptoticRay}
\leanok
...
\lean{PoincareLib.exists_isAsymptoticRay}
\leanok
...
\lean{PoincareLib.IsAsymptoticRay.busemann_apply}
\leanok
...
\lean{PoincareLib.IsAsymptoticRay.busemann_le}
\leanok
...
\lean{PoincareLib.endsTransition}
\leanok
\source{morgan-tian}
...
\lean{PoincareLib.continuous_endsTransition}
\leanok
\uses{def:ends-transition}
...
\lean{PoincareLib.endsTransition_refl}
\leanok
\uses{def:ends-transition}
...
\lean{PoincareLib.endsTransition_trans}
\leanok
\uses{def:ends-transition}
...
\lean{PoincareLib.deriv_deriv_nonpos_of_isLocalMax}
\leanok
...
\lean{PoincareLib.mfderiv_eq_zero_of_isLocalMax}
\leanok
...
\lean{PoincareLib.hessianAt_nonpos_of_isLocalMax}
\leanok
...
\lean{PoincareLib.exists_contMDiff_eventuallyEq_of_contMDiffOn}
\leanok
...
\lean{PoincareLib.laplacianAt_nonpos_of_isLocalMaxOn}
\leanok
\uses{lem:laplacian-local-formula}
...
\lean{PoincareLib.hopf_strong_maximum}
\leanok
...
\lean{PoincareLib.metricNormSq,PoincareLib.contMDiff_metricNormSq,PoincareLib.dir_metricNormSq,PoincareLib.dir_metricNormSq_gradientField,PoincareLib.gradientField_metricNormSq_gradientField,PoincareLib.hessian_metricNormSq_gradientField}
\leanok
...
\uses{lem:hessian-symmetric}
\lean{PoincareLib.hessianNormSqAt}
\leanok
...
\lean{PoincareLib.hessianNormSqAt_eq_sum,PoincareLib.hessianNormSqAt_nonneg,PoincareLib.hessianNormSqAt_eq_zero_iff,PoincareLib.sq_laplacianAt_le_finrank_mul_hessianNormSqAt}
\leanok
...
\uses{def:hessian-norm-sq,lem:hessian-symmetric}
\lean{PoincareLib.metricInner_cov_gradientField_eq_hessianAt,PoincareLib.sum_metricInner_cov_cov_gradientField_eq_hessianNormSqAt}
\leanok
...
\lean{PoincareLib.chartFrameNorm_section_contMDiffOn,PoincareLib.exists_orthonormalFrame,PoincareLib.orthonormalBasisOfMetricInner}
\leanok
...
\lean{PoincareLib.laplacianAt_eventuallyEq_sum_frame,PoincareLib.contMDiff_laplacianAt,PoincareLib.metricInner_secondCov_middle_congr,PoincareLib.sum_metricInner_secondCov_frame_eq_dir_laplacianAt,PoincareLib.sum_metricInner_secondCov_gradientField_eq_dir_laplacianAt}
\leanok
...
\lean{PoincareLib.laplacianAt_metricNormSq_gradientField,PoincareLib.function_bochner_formula}
\leanok
...
\lean{PoincareLib.hessianNormSqAt_eq_zero_of_bochner,PoincareLib.hessianAt_eq_zero_of_bochner,PoincareLib.cov_gradientField_apply_eq_zero_of_bochner}
\leanok
...
\lean{PoincareLib.chartLocalMap,
  PoincareLib.chartFieldCoord_curveVelocity_snd_eventually,
  PoincareLib.chartFieldCoord_curveVelocity_fst_eventually,
  PoincareLib.curveVelocity_comp_fst_eq,
  PoincareLib.curveVelocity_comp_snd_eq,
  PoincareLib.hasCovDerivAlongAt_fst_curveVelocity_snd,
  PoincareLib.hasCovDerivAlongAt_snd_curveVelocity_fst,
  PoincareLib.hasCovDerivAlongAt_fst_snd_symm,
  PoincareLib.HasCovDerivAlongAt,
  PoincareLib.HasCovDerivAlongAt.unique,
  PoincareLib.HasCovDerivAlongAt.add,
  PoincareLib.HasCovDerivAlongAt.const_smul,
  PoincareLib.HasCovDerivAlongAt.smul_fun,
  PoincareLib.hasCovDerivAlongAt_comp,
  PoincareLib.HasCovDerivAlongAt.hasDerivAt_metricInner,
  PoincareLib.hasGeodesicEquationAt_iff_hasCovDerivAlongAt_velocity_zero,
  PoincareLib.IsParallelAlong,
  PoincareLib.IsParallelAlong.metricInner_eq,
  PoincareLib.IsParallelAlong.apply_eq}
\leanok
...
\lean{PoincareLib.HasCovDerivAlongAt,
  PoincareLib.chartFieldCoord,
  PoincareLib.HasCovDerivAlongAt.unique,
  PoincareLib.HasCovDerivAlongAt.add,
  PoincareLib.HasCovDerivAlongAt.const_smul,
  PoincareLib.HasCovDerivAlongAt.sub,
  PoincareLib.HasCovDerivAlongAt.smul_fun,
  PoincareLib.metricInner_eq_chartMetricInner,
  PoincareLib.HasCovDerivAlongAt.hasDerivAt_metricInner,
  PoincareLib.IsParallelAlong,
  PoincareLib.IsParallelAlong.metricInner_eq,
  PoincareLib.IsParallelAlong.apply_eq,
  PoincareLib.curveVelocity,
  PoincareLib.hasGeodesicEquationAt_iff_hasCovDerivAlongAt_velocity_zero,
  PoincareLib.fieldChartRep,
  PoincareLib.hasCovDerivAlongAt_comp,
  PoincareLib.cov_apply_eq_fderiv_add_chartChristoffelContraction,
  PoincareLib.hasCovDerivAlongAt_comp_cov,
  PoincareLib.hasCovDerivAlongAt_comp_zero,
  PoincareLib.isParallelAlong_comp_of_cov_eq_zero,
  PoincareLib.isParallelAlong_curveVelocity_of_isGeodesic}
\leanok
\uses{thm:levi-civita-connection,def:geodesic}
...
\lean{PoincareLib.isParallelAlong_gradientField_comp_of_bochner,
  PoincareLib.curveVelocity_eq_gradientField_of_bochner,
  PoincareLib.metricInner_curveVelocity_self_of_bochner,
  PoincareLib.hasDerivAt_comp_of_bochner,
  PoincareLib.comp_eq_add_mul_of_bochner,
  PoincareLib.isMIntegralCurve_gradientField_of_bochner,
  PoincareLib.isMIntegralCurve_smoothVectorField_eq,
  PoincareLib.isMIntegralCurve_smoothVectorField_comp_add,
  PoincareLib.IsContGeodesicallyComplete,
  PoincareLib.isContGeodesicallyComplete_of_complete,
  PoincareLib.exists_isMIntegralCurve_gradientField_of_complete,
  PoincareLib.exists_gradientFlowLine_of_bochner,
  PoincareLib.smoothVectorFieldFlow,
  PoincareLib.smoothVectorFieldFlow_zero,
  PoincareLib.smoothVectorFieldFlow_add,
  PoincareLib.smoothVectorFieldFlow_bijective,
  PoincareLib.continuous_smoothVectorFieldFlow,
  PoincareLib.smoothVectorFieldFlowHomeomorph,
  PoincareLib.comp_smoothVectorFieldFlow_gradientField_of_bochner,
  PoincareLib.fderiv_fieldChartRep_gradientField_of_bochner,
  PoincareLib.chartMetricInner_variational_eq_left,
  PoincareLib.exists_localFlow_hasStrictFDerivAt,
  PoincareLib.metricPreserving_of_localFlowRep,
  PoincareLib.exists_flowIsometryBoxAt,
  PoincareLib.metricPreserving_smoothVectorFieldFlow_of_bochner,
  HasStrictFDerivAt.continuousAt_derivMap,
  PoincareLib.contDiffOn_one_of_hasStrictFDerivAt,
  PoincareLib.contMDiffAt_smoothVectorFieldFlow_of_bochner,
  PoincareLib.contMDiff_smoothVectorFieldFlow_of_bochner,
  PoincareLib.exists_localFlow_hasStrictFDerivAt_uncurry,
  PoincareLib.exists_flowJointC1BoxAt,
  PoincareLib.contMDiffAt_smoothVectorFieldFlow_uncurry_of_bochner,
  PoincareLib.contMDiff_smoothVectorFieldFlow_uncurry_of_bochner,
  PoincareLib.mfderiv_smoothVectorFieldFlow_gradientField_of_bochner,
  PoincareLib.pathELength_comp_eq_of_metricPreserving,
  PoincareLib.edist_smoothVectorFieldFlow_le_of_bochner,
  PoincareLib.isometry_smoothVectorFieldFlow_of_bochner}
...
\lean{PoincareLib.nonempty_preimage_of_bochner,
  PoincareLib.isClosed_preimage_of_continuous,
  PoincareLib.metricInner_curveVelocity_gradientField_of_bochner,
  PoincareLib.hasDerivAt_comp_zero_of_bochner,
  PoincareLib.comp_eq_of_bochner_of_metricInner_eq_zero,
  PoincareLib.mapsTo_preimage_of_bochner_of_metricInner_eq_zero,
  PoincareLib.metricInner_gradientField_eq_zero_of_mfderiv_eq_zero,
  PoincareLib.isConnected_preimage_of_bochner,
  PoincareLib.levelSetFlowIsometry,
  PoincareLib.exists_openPartialHomeomorph_comp_symm_eq_affine,
  PoincareLib.hasFDerivAt_comp_extChartAt_symm,
  PoincareLib.mfderiv_ne_zero_of_metricNormSq_gradientField_eq_one,
  PoincareLib.exists_extChartAt_openPartialHomeomorph_comp_symm_eq_affine,
  PoincareLib.levelDifferential,
  PoincareLib.levelRieszVector,
  PoincareLib.mem_orthogonal_levelRieszVector_iff,
  PoincareLib.levelHyperplaneBasis,
  PoincareLib.sliceProj,
  PoincareLib.sliceEmb,
  PoincareLib.adaptedStraightening,
  PoincareLib.levelSliceChart,
  PoincareLib.levelSetChartedSpace,
  PoincareLib.contDiffOn_levelSliceChart_trans,
  PoincareLib.isManifold_levelSet,
  PoincareLib.contMDiff_levelSet_val,
  PoincareLib.mfderiv_levelSet_val_injective,
  PoincareLib.range_mfderiv_levelSet_val,
  PoincareLib.exists_hasCovDerivAlongAt_curveVelocity,
  PoincareLib.metricInner_gradientField_curveVelocity_eq_zero_of_level,
  PoincareLib.metricInner_gradientField_covDerivVelocity_eq_zero_of_level,
  PoincareLib.levelSetInducedMetric,
  PoincareLib.levelSetInducedMetric_metricInner,
  PoincareLib.metricInner_mfderiv_levelSet_val,
  PoincareLib.exists_hasCovDerivAlongAt_curveVelocity_levelSet}
...
\lean{PoincareLib.bochnerSplittingHomeomorph,
  PoincareLib.bochnerSplittingHomeomorphOfComplete,
  PoincareLib.mfderivReal,
  PoincareLib.abs_metricInner_le_sqrt_mul_sqrt,
  PoincareLib.ofReal_abs_sub_le_pathELength,
  PoincareLib.ofReal_abs_sub_le_edist_of_bochner,
  PoincareLib.abs_sub_le_dist_of_bochner,
  PoincareLib.edist_smoothVectorFieldFlow_self_of_bochner,
  PoincareLib.edist_smoothVectorFieldFlow_flow_of_bochner,
  PoincareLib.isMinGeodesicOn_smoothVectorFieldFlow_of_bochner,
  PoincareLib.edist_smoothVectorFieldFlow_pair_le_of_bochner,
  PoincareLib.ofReal_abs_le_edist_smoothVectorFieldFlow_pair_of_bochner,
  PoincareLib.edist_le_edist_smoothVectorFieldFlow_pair_add_of_bochner,
  PoincareLib.isComplete_preimage_of_continuous,
  PoincareLib.isGeodesicRay_smoothVectorFieldFlow_of_bochner,
  PoincareLib.busemann_smoothVectorFieldFlow_of_bochner,
  PoincareLib.sub_le_busemann_smoothVectorFieldFlow_of_bochner,
  PoincareLib.mfderiv_smoothVectorFieldFlow_comp_apply_one_of_bochner,
  PoincareLib.enorm_mfderiv_smoothVectorFieldFlow_comp_of_bochner,
  PoincareLib.pathELength_smoothVectorFieldFlow_comp_of_bochner,
  PoincareLib.pathELength_smoothVectorFieldFlow_comp_levelSet_of_bochner,
  PoincareLib.hasDerivAt_comp_gradientField,
  PoincareLib.enorm_mfderiv_eq_sqrt_metricInner_of_hasMFDerivAt,
  PoincareLib.enorm_mfderiv_levelProjection_of_bochner,
  PoincareLib.edist_levelProjection_le_of_bochner,
  PoincareLib.ofReal_mul_add_mul_le_edist_smoothVectorFieldFlow_pair_of_bochner,
  PoincareLib.ofReal_sqrt_le_edist_smoothVectorFieldFlow_pair_of_bochner,
  PoincareLib.continuous_metricInner_mfderiv_of_contMDiff,
  PoincareLib.pathELength_levelProjection_le_of_bochner,
  PoincareLib.pathELength_eq_ofReal_integral_of_contMDiff,
  PoincareLib.edist_smoothVectorFieldFlow_levelPath_le_of_bochner,
  PoincareLib.edist_smoothVectorFieldFlow_pair_le_ofReal_sqrt_of_bochner,
  PoincareLib.edist_smoothVectorFieldFlow_pair_eq_of_bochner,
  PoincareLib.dist_smoothVectorFieldFlow_pair_of_bochner,
  PoincareLib.busemann_smoothVectorFieldFlow_eq_of_bochner,
  PoincareLib.prod_dist_eq_sqrt_of_L2,
  PoincareLib.dist_eq_sqrt_dist_levelProjection_of_bochner,
  PoincareLib.bochnerSplittingIsometry,
  PoincareLib.metricInner_flowVariation_of_bochner,
  PoincareLib.levelSetInducedMetric,
  PoincareLib.levelSetProductMetric,
  PoincareLib.DCProductMetric_metricInner_mk,
  PoincareLib.levelSetProductMetric_metricInner,
  PoincareLib.levelSetProductMetric_metricInner_ambient,
  PoincareLib.mfderiv_prod_eq_add,
  PoincareLib.mfderiv_bochnerSplittingMap_apply,
  PoincareLib.metricInner_mfderiv_bochnerSplittingMap,
  PoincareLib.mfderiv_bochnerSplittingMap_injective}
...
\lean{PoincareLib.busemann_apply_line}
\leanok
...
\lean{PoincareLib.busemann_add_busemann_neg_nonneg}
\leanok
\uses{def:busemann-function,def:minimizing-geodesic-window}
\source{morgan-tian}
Let $\lambda\colon\Ar\to M$ be a minimizing geodesic line in a
...
\lean{PoincareLib.busemann_add_busemann_neg_apply_line}
\leanok
...
\lean{PoincareLib.ForwardDiffQuotientLE}
\leanok
\source{morgan-tian}
...
\lean{PoincareLib.ForwardDiffQuotientLE.mono}
\leanok
...
\lean{PoincareLib.HasDerivWithinAt.forwardDiffQuotientLE}
\leanok
\uses{def:forward-difference-quotient}
...
\label{fordiffquot}
\lean{PoincareLib.le_of_forwardDiffQuotientLE}
\leanok
\uses{def:forward-difference-quotient}
\source{morgan-tian}
...
\lean{PoincareLib.continuous_iSup_of_compact}
\leanok
...
\lean{PoincareLib.forwardDiffQuotientLE_iSup}
\leanok
...
\lean{PoincareLib.iSup_le_of_forwardDiff_max}
\leanok
\uses{def:forward-difference-quotient}
...
\lean{PoincareLib.exists_forall_hasDerivWithinAt_continuousOn_of_contDiffAt,
  PoincareLib.exists_localFlowAt,
  PoincareLib.exists_localFlow_of_isCompact,
  PoincareLib.exists_isLocalFlow_of_isCompact}
\leanok
...
\lean{PoincareLib.IsLocalFlow,
  PoincareLib.continuousOn_levelMax,
  PoincareLib.forwardDiffQuotientLE_levelMax,
  PoincareLib.levelMax_le_of_isLocalFlow}
\leanok
\uses{def:forward-difference-quotient}
...
\label{fordiffmax}
\lean{PoincareLib.levelMax_le_of_dir_le}
\leanok
\uses{def:forward-difference-quotient}
\source{morgan-tian}
