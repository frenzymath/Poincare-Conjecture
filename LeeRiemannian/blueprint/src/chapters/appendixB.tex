% Source: Lee, "Introduction to Riemannian Manifolds" (2nd ed.), Appendix B "Review of Tensors", PDF pages 401-416 of /home/axel/MathBooks/Introduction to Riemannian Manifolds (Second Edition) 2(1).pdf.
...
Two further counting lemmas concern permutations of a disjoint union $\iota_a \sqcup \iota_b$ with $\#\iota_a = k$ and $\#\iota_b = l$; they drive the collapse of the permutation sums in the characterization of the Hodge star operator (Problem 2-18 of Chapter 2). We say a permutation $\chi$ of $\iota_a \sqcup \iota_b$ \emph{preserves the blocks} if it maps the $\iota_a$-summand into itself, or equivalently the $\iota_b$-summand into itself; the block-preserving permutations are exactly those of the form $\pi \oplus \rho$ with $(\pi, \rho) \in S_{\iota_a} \times S_{\iota_b}$.
