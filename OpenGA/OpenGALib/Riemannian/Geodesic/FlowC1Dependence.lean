...
C¹-dependence theorem (`Riemannian.FlowDependence.hasStrictFDerivAt_of_picardResidual_curve`)
...
velocities (`Riemannian.Exponential.exists_hasStrictFDerivAt_extChartAt_expMap_ball`).
-/
