/- Vendored from DoCarmo `OpenGALib/Riemannian/Exponential/MinimizingPiecewise.lean`.
...
`OpenGALib.PetersenLib.Exponential.Minimizing` from a single differentiable
