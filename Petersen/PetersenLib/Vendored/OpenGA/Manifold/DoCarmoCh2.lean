/- Vendored from DoCarmo `OpenGALib/Riemannian/Manifold/DoCarmoCh2.lean` (identical shared OpenGA infra).
...
import PetersenLib.Vendored.OpenGA.Manifold.DoCarmoCh0
