/- Vendored from DoCarmo `OpenGALib/Riemannian/Manifold/DoCarmoCh0.lean` (identical shared OpenGA infra).
...
import PetersenLib.Vendored.OpenGA.Manifold.HadamardLemma
