...
The passage from "some second variation is negative" to the *diameter* bound and finite `π₁`
(the full statement of Thm. 6.3.3) needs the same "negative second variation ⟹ not locally
minimizing ⟹ diameter bound" bridge that gates Cor. 6.3.2, and is not provided here.
-/
