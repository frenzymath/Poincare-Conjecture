/- Petersen's own Riemannian infrastructure.
   Originally derived from the DoCarmo project's `DoCarmoLib/Riemannian/Manifold/DoCarmoCh0.lean`; it is maintained
...
import PetersenLib.Riemannian.Manifold.HadamardLemma
