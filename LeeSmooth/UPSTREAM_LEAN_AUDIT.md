...
This was already known to the workspace, incidentally:
`DoCarmo/projects/smooth-manifolds-lee/lean-deps/manifest.json` records
`"fullBuildFailed": true` with 14 skipped modules.
