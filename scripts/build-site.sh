...
# Landing page: regenerate the proof-structure overview, then build the index.
# `hgraph site` lays out the project cards right after the hero, above the
# overview diagram (no post-processing needed).
